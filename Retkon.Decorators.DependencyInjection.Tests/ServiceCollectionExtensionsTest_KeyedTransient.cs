...
[TestClass]
public class ServiceCollectionExtensionsTest_KeyedTransient
{
    [TestMethod]
    public async Task ServiceCollectionExtensions_SampleWaiting_Decorate()
    {
        ...
        // Act
        serviceCollection.AddKeyedTransient<ISampleWaitingComponent, SampleWaitingComponent>("MyKey");
    ...
    public void ServiceCollectionExtensions_SampleAdding_Decorate()
    {
        ...
        // Act
        serviceCollection.AddKeyedTransient<ISampleStoring, SampleStoringComponent>("MyKey");
