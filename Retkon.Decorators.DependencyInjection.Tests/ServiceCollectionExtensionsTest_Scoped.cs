...
[TestClass]
public class ServiceCollectionExtensionsTest_Scoped
{
    [TestMethod]
    public async Task ServiceCollectionExtensions_SampleWaiting_Decorate()
    {
        ...
        var sampleWaitingComponent = scope.ServiceProvider.GetRequiredService<ISampleWaitingComponent>();
    ...
    public void ServiceCollectionExtensions_SampleAdding_Decorate()
    {
        ...
        */
        ...
        var sampleStoring = scope.ServiceProvider.GetRequiredService<ISampleStoring>();
