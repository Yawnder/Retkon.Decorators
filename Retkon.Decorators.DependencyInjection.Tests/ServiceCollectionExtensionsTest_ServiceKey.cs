...
[TestClass]
public class ServiceCollectionExtensionsTest_ServiceKey
{
    [TestMethod]
    public async Task ServiceCollectionExtensions_SampleWaiting_Decorate()
    {
        ...
        // Act
        serviceCollection.AddScoped<ISampleWaitingComponent, SampleWaitingComponent>();
        serviceCollection.Decorate<SampleWaitingDecoratorLimiter, ISampleWaitingComponent>(new DecorateOptions { DecoratorServiceKey = "MyKey" });
    ...
    public void ServiceCollectionExtensions_SampleAdding_Decorate()
    {
        ...
        // Act
        serviceCollection.AddScoped<ISampleStoring, SampleStoringComponent>();
        serviceCollection.Decorate<SampleAddingDecorator, ISampleStoring>(new DecorateOptions { DecoratorServiceKey = "MyKey" });
    ...
    [TestMethod]
    public void ServiceCollectionExtensions_SampleAddingMultiply_NoKeyHijacking()
    {
        // Arrange
        var serviceCollection = new ServiceCollection();
        ...
        serviceCollection.AddScoped<ISampleStoring, SampleStoringComponent>();
        serviceCollection.Decorate<SampleAddingDecorator, ISampleStoring>();
        serviceCollection.Decorate<SampleMultiplyDecorator, ISampleStoring>(new DecorateOptions { DecoratorServiceKey = "MyKey1" });
        serviceCollection.Decorate<SampleAddingDecorator, ISampleStoring>(new DecorateOptions { DecoratorServiceKey = "MyKey2" });
        ...
        */
        ...
        var sampleStoring = scope.ServiceProvider.GetRequiredKeyedService<ISampleStoring>("MyKey1");
        sampleStoring.Store(0);

        try
        {
            _ = scope.ServiceProvider.GetRequiredKeyedService<ISampleStoring>("MyKey2");
    ...
    public void ServiceCollectionExtensions_SampleAddingMultiply_AddSkipsMultiplyToo()
    {
        ...
        serviceCollection.AddScoped<ISampleStoring, SampleStoringComponent>();
        serviceCollection.Decorate<SampleAddingDecorator, ISampleStoring>(new DecorateOptions { DecoratorServiceKey = "MyKey" });
        serviceCollection.Decorate<SampleMultiplyDecorator, ISampleStoring>(new DecorateOptions { DecoratorServiceKey = "MyKey" });
        serviceCollection.Decorate<SampleAddingDecorator, ISampleStoring>(
            new DecorateOptions
            {
                SkippedDecoratorTypes = [
